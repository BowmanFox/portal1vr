...
& $msbuild (Join-Path $PSScriptRoot 'l4d2vr.sln') /m "/p:Configuration=$Configuration" /p:Platform=x86 "/p:PlatformToolset=$PlatformToolset" /p:PostBuildEventUseInBuild=false
